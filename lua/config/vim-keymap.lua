...
keymap.set("n", "<C-h>", "<cmd>tabp<CR>", { desc = "Go to previous tab" }) --  go to previous tab
...
vim.keymap.set({ "v", "n" }, "<C-o>", "<C-o>zz", { desc = "Avoid exiting visual mode while trying to indent" })
vim.keymap.set({ "v", "n" }, "<C-i>", "<C-i>zz", { desc = "Avoid exiting visual mode while trying to indent" })
